...
?>
  ...
  // ---------- Validate picture
  function do_ajax_apps_form_edit_users_mob_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_apps_form_edit_users_mob_validate_picture(var_picture, var_script_case_init, do_ajax_apps_form_edit_users_mob_validate_picture_cb);
  } // do_ajax_apps_form_edit_users_mob_validate_picture

  function do_ajax_apps_form_edit_users_mob_validate_picture_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_apps_form_edit_users_mob_validate_picture_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_apps_form_edit_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_apps_form_edit_users_mob_submit_form(var_picture, var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_apps_form_edit_users_mob_submit_form_cb);
...
?>
  ...
  {
    perform_ajax_apps_form_edit_users_mob_navigate_form();
  }

  function perform_ajax_apps_form_edit_users_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
