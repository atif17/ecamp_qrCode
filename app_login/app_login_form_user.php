...
<html lang="en">
	<head>
		...
		<meta name="description" content="<?php echo $this->Ini->Nm_lang['lang_crm_description']; ?>" />
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<link rel="stylesheet" href="../_lib/libraries/grp/crm/main.css">
...
?>
	...
	<body class="page-background" style="background-image:url('../_lib/libraries/grp/crm/crm-bg.jpg');">
		<div class="page">
			<div class="container">
				<div class="grid">
					<div class="col-7">
						<div class="content">
							<h1>
								ECAMP - Email Marketing Campaign
							</h1>
...
<input type="hidden" name="csrf_token" value="<?php echo $this->scCsrfGetToken() ?>" />
							...
							<div class="control">
								...
								<input class="input  sc-js-input " type="password" placeholder="<?php echo $this->Ini->Nm_lang['lang_login_pswrd']; ?>" {SC_FIELD_INFO_pswd}>
							</div>
						...
						<!-- Idiomas -->
						<!--<div class="flag-lang">
							<a class="flags flag-en" href="../app_Login/?lang=en"><img src="../_lib/libraries/grp/crm/en_us.png" style="margin-top: -2px;padding-bottom: 0px;"></a>
							<a class="flags flag-pt" href="../app_Login/?lang=pt"><img src="../_lib/libraries/grp/crm/pt_br.png" style="margin-top: -2px;padding-bottom: 0px;"></a>
							<a class="flags flag-es" href="../app_Login/?lang=es"><img src="../_lib/libraries/grp/crm/es_es.png" style="margin-top: -2px;padding-bottom: 0px;"></a>
						</div>-->
						<hr style="margin: 25px 0 20px;">
						<div id='message'>
							<!--<div class="link">
								<input class="button" type="submit"  onclick="nm_atualiza('alterar');"  value="{links}" />
							</div>-->
						</div>
					</div>
				</div>
		...
		<div class="copyright">
			<p>©Sterling National Financial Group | All rights reserved</p>
		</div>
	</body>	
</html>