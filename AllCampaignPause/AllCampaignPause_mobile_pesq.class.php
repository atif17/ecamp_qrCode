...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "CreatedDate";$Nm_datas[] = "ModifiedTime";$Nm_datas[] = "StartDate";$Nm_datas[] = "StartTime";$Nm_numeric[] = "recid";$Nm_numeric[] = "recurringduration";$Nm_numeric[] = "emailsend";$Nm_numeric[] = "emailcount";$Nm_numeric[] = "bounceemailno";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_campaignname"  <?php echo $str_hide_campaignname?>><?php
      if ($campaignname != "")
      {
      $campaignname_look = (is_string($campaignname) ? substr($this->Db->qstr($campaignname), 1, -1) : $campaignname); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_emailcount"  <?php echo $str_hide_emailcount?>><INPUT  type="text" id="SC_emailcount" name="emailcount" value="<?php echo NM_encode_input($emailcount) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
