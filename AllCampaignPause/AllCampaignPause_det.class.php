...
$_SESSION['scriptcase']['AllCampaignPause']['contr_erro'] = 'off'; 
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['sub_dir'] = array(); 
   ...
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['chave_det']) ; 
...
$nm_saida->saida("</script>\r\n");
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "AllCampaignPause/AllCampaignPause_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
       $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "AllCampaignPause/AllCampaignPause_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
    $removeMargin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['link_info']['remove_margin'] ? 'margin: 0;' : '';
    $removeBorder = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['link_info']['remove_border'] ? 'border-width: 0' : '';
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
...
$_SESSION['scriptcase']['AllCampaignPause']['contr_erro'] = 'off'; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['cmp_acum']);
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"AllCampaignPause_doc.php?nmgp_parms=\" + campo1, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['pdf_det']) 
   { 
       ...
       if ($this->nmgp_botoes['det_pdf'] == "on")
       {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "AllCampaignPause/AllCampaignPause_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=8&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=en_us&conf_socor=N&sc_ver_93=s&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $this->nm_btn_exist['det_print'][] = "Dprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "AllCampaignPause/AllCampaignPause_config_print.php?nm_opc=detalhe&nm_cor=CO&password=n&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
