<?php
@session_start() ;
$_SESSION['scriptcase']['AllCampaignPause']['sc_process_barr'] = true;
require_once('../AllCampaignPause/index.php');
unset($_SESSION['scriptcase']['AllCampaignPause']['sc_process_barr']);
$ExportCtrl = new AllCampaignPause_export_control;
$ExportCtrl->Export_barr();

class AllCampaignPause_export_control
{
