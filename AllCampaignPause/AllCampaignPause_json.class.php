...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "AllCampaignPause/AllCampaignPause_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "AllCampaignPause.json";
...
$_SESSION['scriptcase']['AllCampaignPause']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_name']);
      }
...
$_SESSION['scriptcase']['AllCampaignPause']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "AllCampaignPause_res_json.class.php");
              $this->Res = new AllCampaignPause_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_res_grid']);
          } 
      }
   ...
   function NM_export_campaignname()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->campaignname;
   }
   //----- startdate
   function NM_export_startdate()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->startdate;
   }
   //----- emailcount
   function NM_export_emailcount()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->emailcount;
   }
   //----- emailnosend
   function NM_export_emailnosend()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->emailnosend;
   }
   //----- sentper
   function NM_export_sentper()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sentper;
   }
   //----- bounceemailno
   function NM_export_bounceemailno()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->bounceemailno;
   }
   //----- bounce
   function NM_export_bounce()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->bounce;
   }
   //----- boun
   function NM_export_boun()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->boun;
   }
   //----- noofopen
   function NM_export_noofopen()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->noofopen;
   }
   //----- open
   ...
   function NM_export_totalopen()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->totalopen;
   }
   //----- noofresponse
   function NM_export_noofresponse()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->noofresponse;
   }
   //----- responce
   function NM_export_responce()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->responce;
   }
   //----- totalresponce
   function NM_export_totalresponce()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->totalresponce;
   }
   //----- status
   ...
   function NM_export_recid()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->recid;
   }
   //----- discription
   function NM_export_discription()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->discription;
   }
   //----- mode
   function NM_export_mode()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->mode;
   }
   //----- smtpprofile
   function NM_export_smtpprofile()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->smtpprofile;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Pause All Campaign :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
