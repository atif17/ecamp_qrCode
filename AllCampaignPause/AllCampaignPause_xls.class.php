...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "AllCampaignPause/AllCampaignPause_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "AllCampaignPause_res_xls.class.php");
              $this->Res_xls = new AllCampaignPause_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_AllCampaignPause.zip";
          $this->Arquivo   .= "_AllCampaignPause" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['AllCampaignPause']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['AllCampaignPause']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_campaignname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->campaignname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->campaignname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- startdate
   function NM_export_startdate()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->startdate = substr($this->startdate, 0, 10);
         if (empty($this->startdate) || $this->startdate == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->startdate, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->startdate, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->startdate);
   ...
   function NM_export_emailcount()
   {
         ...
         if (is_numeric($this->emailcount))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->emailcount);
         $this->Xls_col++;
   }
   //----- emailnosend
   function NM_export_emailnosend()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->emailnosend, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->emailnosend, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sentper
   function NM_export_sentper()
   {
         ...
         if (is_numeric($this->sentper))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,###.##';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sentper);
         $this->Xls_col++;
   }
   //----- bounceemailno
   function NM_export_bounceemailno()
   {
         ...
         if (is_numeric($this->bounceemailno))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->bounceemailno);
         $this->Xls_col++;
   }
   //----- bounce
   function NM_export_bounce()
   {
         ...
         if (is_numeric($this->bounce))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,###.##';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->bounce);
         $this->Xls_col++;
   }
   //----- boun
   function NM_export_boun()
   {
         ...
         if (is_numeric($this->boun))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,###.##';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->boun);
         $this->Xls_col++;
   }
   //----- noofopen
   function NM_export_noofopen()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->noofopen, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->noofopen, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- open
   function NM_export_open()
   {
         ...
         if (is_numeric($this->open))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->open);
         $this->Xls_col++;
   }
   //----- totalopen
   function NM_export_totalopen()
   {
         ...
         if (is_numeric($this->totalopen))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->totalopen);
         $this->Xls_col++;
   }
   //----- noofresponse
   function NM_export_noofresponse()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->noofresponse, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->noofresponse, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- responce
   function NM_export_responce()
   {
         ...
         if (is_numeric($this->responce))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->responce);
         $this->Xls_col++;
   }
   //----- totalresponce
   function NM_export_totalresponce()
   {
         ...
         if (is_numeric($this->totalresponce))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->totalresponce);
         $this->Xls_col++;
   }
   //----- status
   ...
   function NM_export_recid()
   {
         ...
         if (is_numeric($this->recid))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->recid);
         $this->Xls_col++;
   }
   //----- discription
   function NM_export_discription()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->discription, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->discription, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- mode
   function NM_export_mode()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->mode, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->mode, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- smtpprofile
   function NM_export_smtpprofile()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->smtpprofile, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->smtpprofile, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- campaignname
   function NM_sub_cons_campaignname()
   {
         $this->campaignname = html_entity_decode($this->campaignname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->campaignname = strip_tags($this->campaignname);
         $this->campaignname = NM_charset_to_utf8($this->campaignname);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->campaignname;
   ...
   //----- startdate
   function NM_sub_cons_startdate()
   {
         $this->startdate = substr($this->startdate, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->startdate;
   ...
   //----- emailcount
   function NM_sub_cons_emailcount()
   {
         $this->emailcount = NM_charset_to_utf8($this->emailcount);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->emailcount;
   ...
   //----- emailnosend
   function NM_sub_cons_emailnosend()
   {
         $this->emailnosend = html_entity_decode($this->emailnosend, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->emailnosend = strip_tags($this->emailnosend);
         $this->emailnosend = NM_charset_to_utf8($this->emailnosend);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->emailnosend;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sentper
   function NM_sub_cons_sentper()
   {
         $this->sentper = NM_charset_to_utf8($this->sentper);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sentper;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,###.##";
         $this->Xls_col++;
   ...
   //----- bounceemailno
   function NM_sub_cons_bounceemailno()
   {
         $this->bounceemailno = NM_charset_to_utf8($this->bounceemailno);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->bounceemailno;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- bounce
   function NM_sub_cons_bounce()
   {
         $this->bounce = NM_charset_to_utf8($this->bounce);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->bounce;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,###.##";
         $this->Xls_col++;
   ...
   //----- boun
   function NM_sub_cons_boun()
   {
         $this->boun = NM_charset_to_utf8($this->boun);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->boun;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,###.##";
         $this->Xls_col++;
   ...
   //----- noofopen
   function NM_sub_cons_noofopen()
   {
         $this->noofopen = html_entity_decode($this->noofopen, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->noofopen = strip_tags($this->noofopen);
         $this->noofopen = NM_charset_to_utf8($this->noofopen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->noofopen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- totalopen
   function NM_sub_cons_totalopen()
   {
         $this->totalopen = NM_charset_to_utf8($this->totalopen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->totalopen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- noofresponse
   function NM_sub_cons_noofresponse()
   {
         $this->noofresponse = html_entity_decode($this->noofresponse, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->noofresponse = strip_tags($this->noofresponse);
         $this->noofresponse = NM_charset_to_utf8($this->noofresponse);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->noofresponse;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- responce
   function NM_sub_cons_responce()
   {
         $this->responce = NM_charset_to_utf8($this->responce);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->responce;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- totalresponce
   function NM_sub_cons_totalresponce()
   {
         $this->totalresponce = NM_charset_to_utf8($this->totalresponce);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->totalresponce;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- recid
   function NM_sub_cons_recid()
   {
         $this->recid = NM_charset_to_utf8($this->recid);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->recid;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- discription
   function NM_sub_cons_discription()
   {
         $this->discription = html_entity_decode($this->discription, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->discription = strip_tags($this->discription);
         $this->discription = NM_charset_to_utf8($this->discription);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->discription;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- mode
   function NM_sub_cons_mode()
   {
         $this->mode = html_entity_decode($this->mode, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->mode = strip_tags($this->mode);
         $this->mode = NM_charset_to_utf8($this->mode);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->mode;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- smtpprofile
   function NM_sub_cons_smtpprofile()
   {
         $this->smtpprofile = html_entity_decode($this->smtpprofile, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->smtpprofile = strip_tags($this->smtpprofile);
         $this->smtpprofile = NM_charset_to_utf8($this->smtpprofile);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->smtpprofile;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AllCampaignPause']['nolabel'])
       {
