...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ecamp_2023_____AllCampaignPause"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ecamp_2023_____AllCampaignPause"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['AllCampaignPause']['embutida_filho'] as $ind => $sc_init)
          {
