...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['app_menu']['glo_nm_perfil']         = "conn_mysql_phpadmin";
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtptable") . "/grid_smtptable_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtptable") . "/grid_smtptable_ini.txt");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtptable']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtptable'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tbl_mandrill_templates") . "/grid_tbl_mandrill_templates_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tbl_mandrill_templates") . "/grid_tbl_mandrill_templates_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_mandrill_templates']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_mandrill_templates'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_campaign") . "/grid_campaign_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_campaign") . "/grid_campaign_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_campaign']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_campaign'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_grid_sec_users") . "/apps_grid_sec_users_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_grid_sec_apps") . "/apps_grid_sec_apps_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_grid_sec_groups") . "/apps_grid_sec_groups_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_grid_sec_users_groups") . "/apps_grid_sec_users_groups_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_search_sec_groups") . "/apps_search_sec_groups_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_sync_apps") . "/apps_sync_apps_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apps_Login") . "/apps_Login_ini.txt"))
{
...
$app_menu_menuData['data'] .= "item_22|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
$app_menu_menuData['data'] .= "item_38|..|" . $nm_var_lab[1] . "||" . $nm_var_hint[1] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtptable']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtptable']) == "on")
{
    $app_menu_menuData['data'] .= "item_40|...|" . $nm_var_lab[2] . "|app_menu_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_smtptable&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_39|...|" . $nm_var_lab[3] . "|app_menu_form_php.php?sc_item_menu=item_39&sc_apl_menu=list_tbl_mandrill_info&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_mandrill_templates']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_mandrill_templates']) == "on")
{
    $app_menu_menuData['data'] .= "item_26|..|" . $nm_var_lab[4] . "|app_menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_tbl_mandrill_templates&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_campaign']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_campaign']) == "on")
{
    $app_menu_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_btns_mail'] . "|app_menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_campaign&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

$app_menu_menuData['data'] .= "item_41|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $app_menu_menuData['data'] .= "item_42|..|" . $this->Nm_lang['lang_list_users'] . "|app_menu_form_php.php?sc_item_menu=item_42&sc_apl_menu=apps_grid_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_43|..|" . $this->Nm_lang['lang_list_apps'] . "|app_menu_form_php.php?sc_item_menu=item_43&sc_apl_menu=apps_grid_sec_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_44|..|" . $this->Nm_lang['lang_list_groups'] . "|app_menu_form_php.php?sc_item_menu=item_44&sc_apl_menu=apps_grid_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_51|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|app_menu_form_php.php?sc_item_menu=item_51&sc_apl_menu=apps_grid_sec_users_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_45|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|app_menu_form_php.php?sc_item_menu=item_45&sc_apl_menu=apps_search_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['apps_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_sync_apps']) == "on")
{
    $app_menu_menuData['data'] .= "item_46|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|app_menu_form_php.php?sc_item_menu=item_46&sc_apl_menu=apps_sync_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['apps_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_Login']) == "on")
{
    $app_menu_menuData['data'] .= "item_52|..|" . $nm_var_lab[5] . "|app_menu_form_php.php?sc_item_menu=item_52&sc_apl_menu=apps_Login&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->app_menu_target('_parent') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_smtptable&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtptable']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtptable']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_39&sc_apl_menu=list_tbl_mandrill_info&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['list_tbl_mandrill_info']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['list_tbl_mandrill_info']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_tbl_mandrill_templates&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_mandrill_templates']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_mandrill_templates']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_campaign&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_campaign']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_campaign']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_42&sc_apl_menu=apps_grid_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_43&sc_apl_menu=apps_grid_sec_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_44&sc_apl_menu=apps_grid_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_51&sc_apl_menu=apps_grid_sec_users_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_45&sc_apl_menu=apps_search_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_46&sc_apl_menu=apps_sync_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_52&sc_apl_menu=apps_Login&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apps_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apps_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Android_Orange_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "scriptcase_Android_Orange" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "scriptcase_Android_Orange" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
