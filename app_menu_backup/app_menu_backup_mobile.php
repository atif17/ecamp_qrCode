...
<html>
    <head>
        ...
        <title>{lang_crm_title}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["app_menu_backup"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_SweetGoldenSand/Sc9_SweetGoldenSand_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_SweetGoldenSand/Sc9_SweetGoldenSand_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["app_menu_backup"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["app_menu_backup"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($app_menu_backup_menuData["data"]) && is_array($app_menu_backup_menuData["data"]) && !empty($app_menu_backup_menuData["data"]))
    {
        foreach($app_menu_backup_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($app_menu_backup_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
