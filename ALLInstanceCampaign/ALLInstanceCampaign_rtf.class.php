...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "ALLInstanceCampaign.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['ALLInstanceCampaign']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_name']);
      }
...
$_SESSION['scriptcase']['ALLInstanceCampaign']['contr_erro'] = 'off'; 
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
