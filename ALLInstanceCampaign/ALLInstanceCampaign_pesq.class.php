...
class ALLInstanceCampaign_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . ALLInstanceCampaign_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . ALLInstanceCampaign_pack_protect_string($Tipo_filter[0]) . "\">.." . ALLInstanceCampaign_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_campaignname')
      {
          $campaignname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_campaignname($campaignname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "CreatedDate";$Nm_datas[] = "ModifiedTime";$Nm_datas[] = "StartDate";$Nm_datas[] = "StartTime";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Pause All Campaign</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>ALLInstanceCampaign/ALLInstanceCampaign_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="ALLInstanceCampaign_ajax_search.js"></script>
 <script type="text/javascript" src="ALLInstanceCampaign_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="ALLInstanceCampaign_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['ALLInstanceCampaign']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['ALLInstanceCampaign']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_campaignname_cond#NMF#' + search_get_sel_txt('SC_campaignname_cond') + '@NMF@';
  str_out += 'SC_campaignname#NMF#' + search_get_text('SC_campaignname') + '@NMF@';
  str_out += 'id_ac_campaignname#NMF#' + search_get_text('id_ac_campaignname') + '@NMF@';
  ...
  str_out += 'SC_emailcount_cond#NMF#' + search_get_sel_txt('SC_emailcount_cond') + '@NMF@';
  str_out += 'SC_emailcount#NMF#' + search_get_text('SC_emailcount') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_campaignname").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_campaignname").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_campaignname",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_campaignname").val(ui.item.value);
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Pause All Campaign</div>
...
<?php
   ...
   {
      global 
             $campaignname_cond, $campaignname, $campaignname_autocomp,
             $status_cond, $status, $status_autocomp,
             $emailcount_cond, $emailcount,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['ALLInstanceCampaign']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['ALLInstanceCampaign']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['ALLInstanceCampaign']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $campaignname = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['campaignname']; 
          $campaignname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['campaignname_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['status_cond']; 
          $emailcount = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['emailcount']; 
          $emailcount_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['emailcount_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['NM_operador']; 
          if (strtoupper($emailcount_cond) != "II" && strtoupper($emailcount_cond) != "QP" && strtoupper($emailcount_cond) != "NP" && strtoupper($emailcount_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($emailcount, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($campaignname_cond) || empty($campaignname_cond))
      {
         $campaignname_cond = "eq";
      }
      if (!isset($status_cond) || empty($status_cond))
      {
         $status_cond = "eq";
      }
      if (!isset($emailcount_cond) || empty($emailcount_cond))
      {
         $emailcount_cond = "eq";
      }
      ...
      $str_hide_campaignname = (in_array($campaignname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_status = (in_array($status_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_emailcount = (in_array($emailcount_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($campaignname)) ? strpos($campaignname, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $campaignname = substr($campaignname, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($emailcount) || $emailcount == "")
      {
          $emailcount = "";
      }
      if (isset($emailcount) && !empty($emailcount))
      {
         $tmp_pos = (is_string($emailcount)) ? strpos($emailcount, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $emailcount = substr($emailcount, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_campaignname_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['campaignname'])) ? $this->New_label['campaignname'] : "Campaign Name"; ?></TD>
      
      <INPUT type="hidden" id="SC_campaignname_cond" name="campaignname_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_campaignname" <?php echo $str_hide_campaignname?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['campaignname'])) ? $this->New_label['campaignname'] : "Campaign Name";
 $nmgp_tab_label .= "campaignname?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $campaignname;
      }
?>
<INPUT  type="text" id="SC_campaignname" name="campaignname" value="<?php echo NM_encode_input($campaignname) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_campaignname" name="campaignname_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_status" name="status" value="<?php echo NM_encode_input($status) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_status" name="status_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_emailcount_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['emailcount'])) ? $this->New_label['emailcount'] : "Total"; ?></TD>
      
      <INPUT type="hidden" id="SC_emailcount_cond" name="emailcount_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_emailcount" <?php echo $str_hide_emailcount?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['emailcount'])) ? $this->New_label['emailcount'] : "Total";
 $nmgp_tab_label .= "emailcount?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_emailcount" name="emailcount" value="<?php echo NM_encode_input($emailcount) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("ALLInstanceCampaign_help.txt"))
   {
      $Arq_WebHelp = file("ALLInstanceCampaign_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['ALLInstanceCampaign']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['ALLInstanceCampaign']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.campaignname_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_campaignname'), document.F1.campaignname_cond, 'campaignname');
   document.F1.campaignname.value = "";
   document.F1.campaignname_autocomp.value = "";
   ...
   document.F1.emailcount_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_emailcount'), document.F1.emailcount_cond, 'emailcount');
   document.F1.emailcount.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "ecamp_2023/ALLInstanceCampaign";
   ...
   function inicializa_vars()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_campaignname_cond'] = 'cond';
      $tp_fields['SC_campaignname'] = 'text_aut';
      $tp_fields['id_ac_campaignname'] = 'text_aut';
      $tp_fields['SC_status_cond'] = 'cond';
      $tp_fields['SC_status'] = 'text_aut';
      $tp_fields['id_ac_status'] = 'text_aut';
      $tp_fields['SC_emailcount_cond'] = 'cond';
      $tp_fields['SC_emailcount'] = 'text';
   ...
   {
      global $campaignname_cond, $campaignname, $campaignname_autocomp,
             $status_cond, $status, $status_autocomp,
             $emailcount_cond, $emailcount, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($campaignname_autocomp) && empty($campaignname))
      {
          $campaignname = $campaignname_autocomp;
      }
      if (!empty($status_autocomp) && empty($status))
      {
          $status = $status_autocomp;
      }
      $campaignname_cond_salva = $campaignname_cond; 
      if (!isset($campaignname_input_2) || $campaignname_input_2 == "")
      {
          $campaignname_input_2 = $campaignname;
      }
      ...
      $emailcount_cond_salva = $emailcount_cond; 
      if (!isset($emailcount_input_2) || $emailcount_input_2 == "")
      {
          $emailcount_input_2 = $emailcount;
      }
      if ($emailcount_cond != "in")
      {
          nm_limpa_numero($emailcount, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['campaignname'] = $campaignname; 
      if (is_array($campaignname) && !empty($campaignname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['val'][0] = $campaignname;
      }
      elseif ($campaignname_cond_salva == "nu" || $campaignname_cond_salva == "nn" || $campaignname_cond_salva == "ep" || $campaignname_cond_salva == "ne" || !empty($campaignname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['val'][0][0] = $campaignname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['campaignname_cond'] = $campaignname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['cmp'] = "campaignname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['opc'] = $campaignname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq']['campaignname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['status'] = $status; 
      if (is_array($status) && !empty($status))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['val'][0] = $status;
      }
      elseif ($status_cond_salva == "nu" || $status_cond_salva == "nn" || $status_cond_salva == "ep" || $status_cond_salva == "ne" || !empty($status))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['val'][0][0] = $status;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['status_cond'] = $status_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['cmp'] = "status"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['opc'] = $status_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq']['status'] = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['emailcount'] = $emailcount; 
      if (is_array($emailcount) && !empty($emailcount))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['val'][0] = $emailcount;
      }
      elseif ($emailcount_cond_salva == "nu" || $emailcount_cond_salva == "nn" || $emailcount_cond_salva == "ep" || $emailcount_cond_salva == "ne" || !empty($emailcount))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['val'][0][0] = $emailcount;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['emailcount_cond'] = $emailcount_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['cmp'] = "emailcount"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid]['opc'] = $emailcount_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['grid_pesq']['emailcount'] = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($campaignname != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['campaignname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['campaignname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['campaignname'] = $campaignname;
      }
      $nmgp_def_dados = array();
    if ($status != '') {
      $status_look = (is_string($status) ? substr($this->Db->qstr($status), 1, -1) : $status); 
      ...
      $this->cmp_formatado['emailcount'] = $Conteudo;

      //----- $campaignname
      $this->Date_part = false;
      if (isset($campaignname) || $campaignname_cond == "nu" || $campaignname_cond == "nn" || $campaignname_cond == "ep" || $campaignname_cond == "ne")
      {
         $this->monta_condicao("CampaignName", $campaignname_cond, $campaignname, "", "campaignname", "VARCHAR", false);
      }
      ...
      //----- $emailcount
      $this->Date_part = false;
      if (isset($emailcount) || $emailcount_cond == "nu" || $emailcount_cond == "nn" || $emailcount_cond == "ep" || $emailcount_cond == "ne")
      {
         $this->monta_condicao("EmailCount", $emailcount_cond, $emailcount, "", "emailcount", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['ALLInstanceCampaign']['cond_pesq'] .= $this->NM_operador;
