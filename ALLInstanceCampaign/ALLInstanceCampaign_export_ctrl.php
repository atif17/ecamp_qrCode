<?php
@session_start() ;
$_SESSION['scriptcase']['ALLInstanceCampaign']['sc_process_barr'] = true;
require_once('../ALLInstanceCampaign/index.php');
unset($_SESSION['scriptcase']['ALLInstanceCampaign']['sc_process_barr']);
$ExportCtrl = new ALLInstanceCampaign_export_control;
$ExportCtrl->Export_barr();

class ALLInstanceCampaign_export_control
{
